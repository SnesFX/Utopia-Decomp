...
public class SUOnlineMenu : MonoBehaviour
{
    public GUISkin Skin;
    public Vector2 WidthAndHeight = new Vector2(600, 400);
    private string roomName = "Sonic Utopia Online Server";

    private Vector2 scrollPos = Vector2.zero;

    private bool connectFailed = false;

    public static readonly string SceneNameMenu = "SUOnlineLobby";

    public static readonly string SceneNameGame = "SandboxOnline";
